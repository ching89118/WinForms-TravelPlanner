    ...
    public class CSVFile
    {
        ...
        public static void SavePlanOverviewToCsv(string planName, DataGridView gridView)
        {
            ...
            if (file)//存在，是否覆蓋
            {
                ...
                DialogResult Result = MessageBox.Show("CSV file has existed, Do you want to override?", "Override",
        ...
        private static void ExportDgvToCsv(string planName, DataGridView gridView)
        {
            ...
            //output header data
            string strHeader = "";
            for (int i = 0; i < gridView.Columns.Count; i++)/* userControl屬性Columns*/
            {
                strHeader += gridView.Columns[i].HeaderText + delimiter;
            }
            ...
            for (int j = 0; j < gridView.Rows.Count; j++)/* userControl屬性Rows*/
            {
                ...
                {
                    strRowValue += gridView.Rows[j].Cells[k].Value + delimiter;
            ...
            using (var file = new StreamWriter(completePath, false, System.Text.Encoding.UTF8))
            {
                ...
                foreach (var allData in placeAllList)
                {
                    context +=
                        ...
                        $"{allData.details.PhoneNumber},{allData.details.OpeningPeriods},{allData.StartTime},{allData.EndTime}," +
                        $"{allData.Cost}\r\n";
        ...
        /// <param name="labelSender"></param>
        /// <param name="placeDetails"></param>
        public static void CSVGeneratorFileExsited(List<PlaceAllData> placeAllList, string planName, string labelSender, PlaceDetails placeDetails)
        {
        ...
        public static void SavePlaceAllDataToCsv(string labelSender, string planName, List<PlaceAllData> placeAllList, PlaceDetails placeDetails, Label label_saved2)
        {
            ...
            string completePath = string.Empty;
                ...
                if (file)//存在，是否覆蓋
                {
                    ...
                    if (Result == DialogResult.OK)
                    {
                        ...
                        CSVFile.CSVGeneratorFileExsited(placeAllList, planName, labelSender, placeDetails);
                        label_saved2.Text = "Saved!";
